...
$sql_num = "select count(1) as num from qiugou where 1 " . $sql;
...
$sql_data = " select id,pic,productName,checked from qiugou where 1 " . $sql . " limit " . ($current_page - 1) * $numPerPage . "," . $numPerPage;
