...
<div class="page">
    ...
    <form action="index.php?p=admin/links_add_done" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this,navTabAjaxDone);" method="post">
