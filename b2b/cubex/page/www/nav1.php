...
.formbox { width:497px; height:38px; background:url(res/img/bg_formbox.gif) left center repeat-x; padding:6px 0 0 5px; }
.txtbox { width:386px; height:32px; line-height:32px; background:url(res/img/bg_txtbox.gif) no-repeat; color:#999; border:none; padding-left:10px; font-size:14px; vertical-align: middle;margin-top:-27px;}
