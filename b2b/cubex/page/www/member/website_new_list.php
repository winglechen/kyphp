...
Form::init('member_new_list_search');
...
$page = array(
    'url'           => 'index.php?p=www/member/website_new_list&page=',
    'curPage'       => $_POST['page'],
    'numPerPage'    => 10,
    'style'         => 'default',
);
  ...
  <div class="operationArea">
    ...
    <div class="tabswitchborder">
      <div class="searchproducts">
        <form  onsubmit="return checkSubmit(this);"  name="searchForm" id="searchForm" method="post" action="index.php?p=www/member/website_new_list">
            <input type="hidden" name="namespace" value="member_new_list_search" />
            <input type="hidden" name="pageParam" value="page" />
            <input type="hidden" name="corpid" value="<?php echo $_SESSION['id']; ?>" />
          <label for="label">新闻标题</label>
          <input type="text"  onfocus="checkInput(this);" required="true"  name="title" id="title" value="" class="productSearchInput" style="height:19px;line-height:19px;">
...
<tr onmouseover="this.bgColor='#EFFFEE';" onmouseout="this.bgColor='#FFFFFF';" bgcolor="#FFFFFF">
    <td align="left" valign="top" class="datadescription">
        <a href="index.php?p=www/member/website_new_add&id=<?php echo $row['id']; ?>"><?php echo $row['name']; ?></a>
    </td>
    ...
    <td align="center" valign="middle" class="datamod">
        <table width="100%" border="0" cellspacing="3" cellpadding="0" class="modopration">
            <tbody>
                <tr>
                    <a href="index.php?p=www/member/website_new_add&id=<?php echo $row['id']; ?>">修改</a></td>
                </tr>
            </tbody>
        </table>
    </td>
