...
?>
				 ...
				 <div class="right">
  <form  onsubmit="return checkSubmit(this);"  name="publishForm" id="publishForm" method="post" action="index.php?p=www/member/website_nav2_add_done"  enctype="multipart/form-data" >
    ...
    <div class="formblock">
      ...
      <div class="formline" style="display:<?php if(!$get) echo 'block'; else echo 'none'; ?>">
       ...
       <div class="formcontent">
            <label><input type="radio" name="urltype" <?php if(0 == $form['urltype']) echo ' checked="checked" '; ?>  onclick="setUrlType(0);"  value="0">自定义</label>
            <label><input type="radio" name="urltype" <?php if(1 == $form['urltype']) echo ' checked="checked" '; ?>  onclick="setUrlType(1);"  value="1">产品分类</label>
            <label><input type="radio" name="urltype" <?php if(2 == $form['urltype']) echo ' checked="checked" '; ?>  onclick="setUrlType(2);" value="2">新闻分类</label>
            <label><input type="radio" name="urltype" <?php if(3 == $form['urltype']) echo ' checked="checked" '; ?>  onclick="setUrlType(3);" value="3">自定义页面</label>
