...
Form::init('member_nav_list_search');
...
$page = array(
    'url'           => 'index.php?p=www/member/website_nav_list&page=',
    'curPage'       => $_POST['page'],
    'numPerPage'    => 10,
    'style'         => 'default',
);

$data = Mnav::lists('id,name,url',$condition,$_POST,$page);
...
<tr onmouseover="this.bgColor='#EFFFEE';" onmouseout="this.bgColor='#FFFFFF';" bgcolor="#FFFFFF">   
    <td align="left" valign="top" class="datadescription">
        <a href="index.php?p=www/member/website_nav_add&id=<?php echo $row['id']; ?>"><?php echo $row['name']; ?></a>
    </td>
    <td align="left" valign="middle" class="dataexpire">
        <?php echo $row['url']; ?>
    </td>
