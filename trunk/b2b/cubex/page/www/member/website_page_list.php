  ...
  <div class="operationArea">
    ...
    <div class="tabswitchborder">
      <div class="searchproducts">
        <form  onsubmit="return checkSubmit(this);"  name="searchForm" id="searchForm" method="post" action="index.php?p=www/member/website_page_list">
    ...
    <td align="center" valign="middle" class="datamod">
        <table width="100%" border="0" cellspacing="3" cellpadding="0" class="modopration">
            <tbody>
                <tr>
                    <td align="center">
                        <a href="index.php?p=www/member/website_page_add&id=<?php echo $row['id']; ?>">修改</a>
                        <a href="index.php?p=www/member/website_page_del&id=<?php echo $row['id']; ?>">删除</a>
                    </td>
                </tr>
            </tbody>
        </table>
